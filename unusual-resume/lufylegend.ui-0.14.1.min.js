var LButtonSample1 = (function() {
    ...
    LButtonSample1.prototype.setLabel = function(text) {
        var s = this;
        s.bitmap_over.getChildAt(0).text = s.bitmap_up.back.getChildAt(
            0).text = text;
        s.baseWidth = s.width = s.bitmap_up.back.getChildAt(0).getWidth() +
            s.bitmap_up.back.getChildAt(0).size;
        s.backgroundSet = null;
    };
    LButtonSample1.prototype._onDraw = function(s) {
        var co = s.getRootCoordinate(),
            labelText;
        if (s.backgroundSet == s.backgroundColor && s.widthSet == s
            .width && s.heightSet == s.height && s.xSet == co.x &&
            s.ySet == co.y) {
            return;
        }
        ...
        labelText.x = (s.width - s.baseWidth + labelText.size) *
            0.5;
        labelText.y = (s.height - s.baseHeight + labelText.size) *
            0.5;
        ...
        labelText.y = (s.height - s.baseHeight + labelText.size) *
            0.5;
        var grd = LGlobal.canvas.createLinearGradient(0, -s.height *
            0.5, 0, s.height * 2);
        grd.addColorStop(0, "#FFFFFF");
        grd.addColorStop(1, s.backgroundColor);
        var grd2 = LGlobal.canvas.createLinearGradient(0, -s.height,
            0, s.height * 2);
        ...
        s.bitmap_up.shadow.graphics.drawRoundRect(0, "#000000", [1,
            1, s.widthSet - 2, s.heightSet - 2, s.heightSet *
            0.1
        ], true, "#000000");
        s.bitmap_up.back.graphics.drawRect(1, s.backgroundColor, [0,
            0, s.widthSet, s.heightSet
        ], true, grd);
        s.bitmap_up.back.graphics.drawRect(0, s.backgroundColor, [1,
            s.heightSet * 0.5, s.widthSet - 2, s.heightSet *
            0.5 - 1
        ], true, grd2);
        s.bitmap_over.graphics.drawRect(1, s.backgroundColor, [0, 0,
            s.widthSet, s.heightSet
        ], true, grd);
        s.bitmap_over.graphics.drawRect(0, s.backgroundColor, [1, s
            .heightSet * 0.5, s.widthSet - 2, s.heightSet *
            0.5 - 1
        ], true, grd2);
        s.disableState.graphics.drawRect(1, s.backgroundColor, [0,
            0, s.widthSet, s.heightSet
        ], true, grd);
        s.disableState.graphics.drawRect(0, s.backgroundColor, [1,
            s.heightSet * 0.5, s.widthSet - 2, s.heightSet *
            0.5 - 1
        ], true, grd2);
    };
...
var LButtonSample2 = (function() {
    ...
    LButtonSample2.prototype._onDraw = function(s) {
        ...
        s.bitmap_over.graphics.clear();
        s.bitmap_up.shadow.graphics.clear();
        s.bitmap_up.back.graphics.drawRoundRect(1, s.backgroundColor, [
            0, 0, s.width, s.height, s.height * 0.1
        ], true, grd);
        s.bitmap_up.back.graphics.drawRoundRect(0, s.backgroundColor, [
            1, s.height * 0.5, s.width - 2, s.height * 0.5 -
            1, s.height * 0.1
        ], true, grd2);
        s.bitmap_over.graphics.drawRoundRect(1, s.backgroundColor, [
            0, 0, s.width, s.height, s.height * 0.1
        ], true, grd);
        s.bitmap_over.graphics.drawRoundRect(0, s.backgroundColor, [
            1, s.height * 0.5, s.width - 2, s.height * 0.5 -
            1, s.height * 0.1
        ], true, grd2);
        s.disableState.graphics.drawRoundRect(1, s.backgroundColor, [
            0, 0, s.width, s.height, s.height * 0.1
        ], true, grd);
        s.disableState.graphics.drawRoundRect(0, s.backgroundColor, [
            1, s.height * 0.5, s.width - 2, s.height * 0.5 -
            1, s.height * 0.1
        ], true, grd2);
    };
...
var LCheckBox = (function() {
    function LCheckBox(layer, layerSelect) {
        ...
        if (!layer) {
            ...
            layer = new LSprite();
            layer.graphics.drawRoundRect(1, "#CCCCCC", [0, 0, 20, 20, 4],
                true, grd);
        } else {
            layer = layer.clone();
        }
...
var LComboBox = (function() {
    function LComboBox(size, color, font, layerBack, layerUp, layerOver) {
        ...
        if (!layerBack) {
            ...
            layerBack.graphics.drawRoundRect(1, "#999999", [0, 0, 200,
                30, 4
            ], true, "#f5f5f9");
        }
        ...
        if (!layerUp || !layerOver) {
            ...
            grd.addColorStop(1, "#CCCCCC");
            up = new LSprite();
            up.graphics.drawRoundRect(1, "#CCCCCC", [0, 0, 22, 22, 2],
                true, grd);
            up.graphics.drawVertices(1, "#CCCCCC", [
                [6, 6],
                [16, 6],
                [11, 18]
            ], true, "#008000");
            ...
            down = new LSprite();
            down.graphics.drawRoundRect(1, "#CCCCCC", [0, 0, 22, 22, 2],
                true, grd);
            down.graphics.drawVertices(1, "#CCCCCC", [
                [6, 6],
                [16, 6],
                [11, 18]
            ], true, "#32CD32");
    ...
    LComboBox.prototype.setChild = function(child) {
        var s = this,
            i, l;
        if (!child || typeof child.value == UNDEFINED || typeof child
            .label == UNDEFINED) {
    ...
    LComboBox.prototype.showChildList = function() {
        ...
        translucent.graphics.drawRect(0, "#000000", [0, 0, LGlobal.width,
            LGlobal.height
        ], true, "#000000");
        translucent.alpha = 0;
        LGlobal.stage.addChild(translucent);
        translucent.addEventListener(LMouseEvent.MOUSE_UP, function(
            e) {
        ...
        translucent.addEventListener(LMouseEvent.MOUSE_DOWN,
            function(e) {});
        translucent.addEventListener(LMouseEvent.MOUSE_MOVE,
            function(e) {});
        translucent.addEventListener(LMouseEvent.MOUSE_OVER,
            function(e) {});
        translucent.addEventListener(LMouseEvent.MOUSE_OUT,
            function(e) {});
        ...
        s.listView.resize(s.listView.cellWidth, s.listView.cellHeight *
            (s.list.length > s.maxIndex ? s.maxIndex : s.list.length)
        );
...
var LComboBoxChild = (function() {
    ...
    LComboBoxChild.prototype.setStatus = function(content, comboBox) {
        ...
        self.graphics.drawRect(0, "#f5f5f9", [0, 0, listView.cellWidth,
            listView.cellHeight
        ], true, "#f5f5f9");
    ...
    LComboBoxChild.prototype.setSelectStatus = function(content,
        comboBox) {
        var self = this;
        var listView = comboBox.listView;
        self.graphics.clear();
        self.graphics.drawRect(0, "#CCCCCC", [0, 0, listView.cellWidth,
            listView.cellHeight
        ], true, "#CCCCCC");
        var text = new LTextField();
        text.size = comboBox.size;
    ...
    LComboBoxChild.prototype.onTouch = function(event) {
        ...
        if (listView._ll_selectedChild) {
            ...
            listView._ll_selectedChild.setStatus(listView._ll_selectedChild
                .content, listView._ll_selectedChild.comboBox);
        }
        self.removeAllChild();
    ...
    LComboBoxChild.prototype.onClick = function(event) {
        ...
        for (var i = LGlobal.stage.numChildren - 1; i >= 0; i--) {
            if (LGlobal.stage.childList[i].constructor.name ==
                "LListViewDragObject") {
...
var LMenubar = (function() {
    function LMenubar(list, style) {
        ...
        back.graphics.drawRect(0, "#ffffff", [-LGlobal.width, -LGlobal.height,
            LGlobal.width * 2, LGlobal.height * 2
        ]);
        s.addChild(back);
        s.back = back;
        s.back.root = s;
        ...
        s.back.addEventListener(LMouseEvent.MOUSE_DOWN, function(e) {
            ...
            for (var j = 0; j < root.childList.length; j++) {
                if (root.childList[j].mainMenu) {
                    ...
                    root.childList[j].graphics.drawRect(0, root
                        .style.lineColor, [0, 0, rW, rH],
                        true, root.style.backgroundColor);
                    continue;
                }
    ...
    LMenubar.prototype.mousedown = function(e) {
        ...
        if (target.mainMenu) {
            ...
            target.graphics.drawRect(0, root.style.selectColor, [0,
                0, sW, sH
            ], true, root.style.selectColor);
            if (target.menuList && target.menuList.length) {
                for (var j = 0; j < target.menuList.length; j++) {
                    ...
                    target.menuList[j].graphics.drawRect(1, root.style
                        .lineColor, [0, 0, target.childWidth,
                            target.childHeight
                        ], true, root.style.itemBackgroundColor
                    );
                    if (target.menuList[j].arrow) {
                        target.menuList[j].arrow.x = target.childWidth -
                            root.style.horizontalIndent * 2;
                    }
                }
            }
            return;
    ...
    LMenubar.prototype.mousemove = function(e) {
        ...
        if (root.select) {
            ...
            root.select.graphics.drawRect(root.select.mainMenu ? 0 :
                1, root.style.lineColor, [0, 0, rW, rH], true,
                root.select.mainMenu ? root.style.backgroundColor :
                root.style.itemBackgroundColor);
        }
        var sW = target.getWidth();
        var sH = target.getHeight();
        target.graphics.clear();
        target.graphics.drawRect(0, root.style.selectColor, [0, 0,
            sW, sH
        ], true, root.style.selectColor);
        if (target.mainMenu) {
            for (var j = 0; j < root.childList.length; j++) {
            ...
            if (root.select.upper.menuList && root.select.upper.menuList
                .length) {
        ...
        if (target.menuList && target.menuList.length) {
            for (var j = 0; j < target.menuList.length; j++) {
                target.menuList[j].visible = true;
                target.menuList[j].graphics.clear();
                target.menuList[j].graphics.drawRect(1, root.style.lineColor, [
                        0, 0, target.childWidth, target.childHeight
                    ], true, target.menuList[j].mainMenu ? root
                    .style.backgroundColor : root.style.itemBackgroundColor
                );
                if (!target.mainMenu) {
    ...
    LMenubar.prototype.setList = function(layer, list, depth, sx, sy) {
        ...
        for (var i = 0; i < list.length; i++) {
            ...
            menu.addChild(label);
            menu.graphics.drawRect(0, s.style.backgroundColor, [0,
                0, label.getWidth() + s.style.horizontalIndent *
                2, label.getHeight() + s.style.verticalIndent *
                2
            ], true, s.style.backgroundColor);
            ...
            if (s.objectIndex == layer.objectIndex) {
                ...
                menu.y = 0 + sy;
                menu.mainMenu = true;
                w += label.getWidth() + s.style.horizontalIndent *
                    2;
                h = label.getHeight() + s.style.verticalIndent * 2;
                if (layer.childWidth < label.getWidth() + s.style.horizontalIndent *
                    2) {
                    layer.childWidth = label.getWidth() + s.style.horizontalIndent *
                        2;
                }
                if (layer.childHeight < label.getHeight() + s.style
                    .verticalIndent * 2) {
                    layer.childHeight = label.getHeight() + s.style
                        .verticalIndent * 2;
                }
            } else {
                menu.x = 0 + sx;
                menu.y = h + sy;
                w = w > label.getWidth() + s.style.horizontalIndent *
                    4 ? w : label.getWidth() + s.style.horizontalIndent *
                    4;
                h += label.getHeight() + s.style.verticalIndent * 2;
                if (layer.childWidth < label.getWidth() + s.style.horizontalIndent *
                    4) {
            ...
            if (child.list && child.list.length > 0) {
                if (s.objectIndex == layer.objectIndex) {
                    s.setList(menu, child.list, depth + 1, menu.x,
                        menu.y + menu.getHeight());
                } else {
                    var arrow = new LSprite();
                    menu.arrow = arrow;
                    menu.addChild(arrow);
                    arrow.x = label.getWidth() + s.style.horizontalIndent *
                        2;
                    arrow.y = label.y;
                    arrow.graphics.drawVertices(0, s.style.textColor, [
                        [0, 0],
                        [0, label.getHeight()],
                        [s.style.horizontalIndent, label.getHeight() *
                            0.5
                        ]
                    ], true, s.style.textColor);
                    s.setList(menu, child.list, depth + 1, menu.x +
                        menu.getWidth() + s.style.horizontalIndent *
                        2, menu.y);
                }
            }
            if (s.objectIndex != layer.objectIndex) {
...
var LMessageBox = (function() {
    ...
    LMessageBox.show = function(properties) {
        ...
        translucent.addEventListener(LMouseEvent.MOUSE_OUT,
            function(e) {});
        var myWindow = new LWindow(properties.width, properties.height,
            properties.title);
        ...
        msgLabel.y = (properties.height - myWindow.bar.getHeight() -
            msgLabel.getHeight()) * 0.5;
...
var LPanel = (function() {
    function LPanel(bitmapData, w, h, x1, x2, y1, y2, overlapping) {
        ...
        if (typeof bitmapData == "string") {
            ...
            d.graphics.drawRoundRect(1, "#000000", [0, 0, w, h, w < 10 ?
                w * 0.5 : 5
            ], true, bitmapData);
        ...
        var ltData = new LBitmapData(bitmapData.image, bitmapData.x,
            bitmapData.y, s.x1, s.y1);
        var mtData = new LBitmapData(bitmapData.image, bitmapData.x + s
            .x1, bitmapData.y, s.x2 - s.x1, s.y1);
        var rtData = new LBitmapData(bitmapData.image, bitmapData.x + s
            .x2, bitmapData.y, bitmapData.width - s.x2, s.y1);
        var lmData = new LBitmapData(bitmapData.image, bitmapData.x,
            bitmapData.y + s.y1, s.x1, s.y2 - s.y1);
        var mmData = new LBitmapData(bitmapData.image, bitmapData.x + s
            .x1, bitmapData.y + s.y1, s.x2 - s.x1, s.y2 - s.y1);
        var rmData = new LBitmapData(bitmapData.image, bitmapData.x + s
            .x2, bitmapData.y + s.y1, bitmapData.width - s.x2, s.y2 -
            s.y1);
        var lbData = new LBitmapData(bitmapData.image, bitmapData.x,
            bitmapData.y + s.y2, s.x1, bitmapData.height - s.y2);
        var mbData = new LBitmapData(bitmapData.image, bitmapData.x + s
            .x1, bitmapData.y + s.y2, s.x2 - s.x1, bitmapData.height -
            s.y2);
        var rbData = new LBitmapData(bitmapData.image, bitmapData.x + s
            .x2, bitmapData.y + s.y2, bitmapData.width - s.x2,
            bitmapData.height - s.y2);
    ...
    LPanel.prototype.resize = function(w, h) {
        ...
        s._ll_w = w;
        s._ll_h = h;
        s.rtBitmap.x = s.rmBitmap.x = s.rbBitmap.x = w - (s.bitmapData
            .width - s.x2);
        s.lbBitmap.y = s.mbBitmap.y = s.rbBitmap.y = h - (s.bitmapData
            .height - s.y2);
        s.lmBitmap.scaleY = s.mmBitmap.scaleY = s.rmBitmap.scaleY =
            (h - s.y1 - (s.bitmapData.height - s.y2) + self.overlapping *
                2) / (s.y2 - s.y1);
        s.mtBitmap.scaleX = s.mmBitmap.scaleX = s.mbBitmap.scaleX =
            (w - s.x1 - (s.bitmapData.width - s.x2) + self.overlapping *
                2) / (s.x2 - s.x1);
    };
    ...
    LPanel.prototype.clone = function() {
        var s = this;
        return new LPanel(s.bitmapData.clone(), s._ll_w, s._ll_h, s
            .x1, s.x2, s.y1, s.y2, self.overlapping);
    };
    return LPanel;
})();
var LRadioChild = (function() {
    function LRadioChild(value, layer, layerSelect) {
        ...
        if (!layer) {
            ...
            grd.addColorStop(1, "#CCCCCC");
            layer = new LSprite();
            layer.graphics.drawArc(1, "#CCCCCC", [0, 0, 10, 0, 2 * Math
                .PI
            ], true, grd);
        } else {
            layer = layer.clone();
        ...
        if (!layerSelect) {
            ...
            grd.addColorStop(1, "#008000");
            layerSelect = new LSprite();
            layerSelect.graphics.drawArc(1, grd, [0, 0, 5, 0, 2 * Math.PI],
                true, grd);
        } else {
            layerSelect = layerSelect.clone();
        }
...
var LRadio = (function() {
    ...
    LRadio.prototype.setChildRadio = function(value, x, y, layer,
        layerSelect) {
        var s = this;
...
var LRange = (function() {
    function LRange() {
        ...
        if (param["backLayer"] && param["selectLayer"]) {
            ...
            h = backLayer.getHeight() > s.sign.getHeight() ? backLayer.getHeight() :
                s.sign.getHeight();
            ...
            s.w = param["width"];
            s.graphics.drawRect(0, "#FFFFFF", [-50, 0, s.w + 100, s.w *
                0.13
            ]);
            var grd = LGlobal.canvas.createLinearGradient(0, 0, 0, s.w *
                0.13);
            grd.addColorStop(0, "#FFFFFF");
            grd.addColorStop(1, "#CCCCCC");
            s.color = grd;
            s.graphics.drawRect(1, "#CCCCCC", [0, s.w * 0.04, s.w, s.w *
                0.03
            ], true, s.color);
            s.sign = new LSprite();
            s.sign.graphics.drawVertices(1, "#CCCCCC", [
                [0, 0],
                [s.w * 0.05, 0],
                [s.w * 0.05, s.w * 0.1],
                [s.w * 0.025, s.w * 0.13],
    ...
    LRange.prototype._onDown = function(event) {
        ...
        if (event.selfX < -s.sign.getWidth() * 0.5 || event.selfX >
            s.w + s.sign.getWidth() * 0.5) {
            return;
        }
        if (s.down) {
            return;
    ...
    LRange.prototype._getValue = function() {
        var s = this;
        var value = s.value;
        s.value = Math.floor((s.sign.x + s.sign.getWidth() * 0.5) *
            100 / s.w);
        if (value != s.value) {
...
var LScrollbar = (function() {
    function LScrollbar(showObject, maskW, maskH, param, wVisible,
        hVisible) {
        var s = this;
        LExtends(s, LSprite, []);
        s.type = "LScrollbar";
        ...
        s._showLayer.graphics.drawRect(0, "#ffffff", [0, 0, maskW,
            maskH
        ]);
        ...
        if (!param) {
            ...
            if (typeof param["back"] != UNDEFINED && typeof param[
                    "select"] != UNDEFINED && typeof param["arraw"] !=
                UNDEFINED) {
        ...
        if (LGlobal.mobile) {
            s._showObject.addEventListener(LMouseEvent.MOUSE_DOWN,
                function(e) {
                    e.currentTarget.startDrag(e.touchPointID);
                });
            s._showObject.addEventListener(LMouseEvent.MOUSE_UP,
                function(e) {
    ...
    LScrollbar.prototype.clone = function() {
        var s = this,
            a = new LScrollbar(s._showObject.clone(), s._maskW, s._maskH,
                s._scrollWidth, s._wVisible, s._hVisible);
        a.copyProperty(s);
        return a;
    };
    LScrollbar.prototype.dragRangeUpdate = function(w, h) {
        ...
        s._showObject.dragRange = new LRectangle(!s._wVisible || w <
            s._maskW ? 0 : s._maskW - w, !s._hVisible || h < s._maskH ?
            0 : s._maskH - h, s._wVisible && w > s._maskW ? w -
            s._maskW : 0, s._hVisible && h > s._maskH ? h - s._maskH :
            0);
    };
    LScrollbar.prototype.onFrame = function(event) {
        ...
        if (s.excluding) {
            for (i = 0, l = s._showObject.numChildren; i < l; i++) {
                ...
                if (child.x + s._showObject.x > s._maskW || child.x +
                    child.getWidth() + s._showObject.x < 0 || child
                    .y + s._showObject.y > s._maskH || child.y +
                    child.getHeight() + s._showObject.y < 0) {
                    child.visible = false;
                } else {
                    child.visible = true;
                }
    ...
    LScrollbar.prototype.resizeWidth = function(value) {
        ...
        if (s._scroll_w_bar == null) {
            ...
            grd = LGlobal.canvas.createLinearGradient(0, 0, s._scrollWidth,
                0);
            grd.addColorStop(0, "#FFFFFF");
            grd.addColorStop(1, "#008000");
            ...
            if (s._ll_bar_select) {
                ...
                s._scroll_w_bar.graphics.drawRoundRect(1, "#CCCCCC", [
                    0, 0, s._scrollWidth * 1.5, s._scrollWidth,
                    s._scrollWidth * 0.5
                ], true, grd);
            }
            if (s._ll_bar_back) {
                ...
                s._scroll_w.graphics.drawRoundRect(1, "#CCCCCC", [s
                    ._scrollWidth, 0, s._mask.getWidth() -
                    s._scrollWidth * 2, s._scrollWidth, s._scrollWidth *
                    0.5
                ], true, grdb);
            }
            if (s._ll_bar_back) {
                ...
                s._scroll_w.graphics.drawRect(0, "#000000", [0, 0,
                    s._scrollWidth, s._scrollWidth
                ]);
                s._scroll_w.graphics.drawVertices(1, "#CCCCCC", [
                    [s._scrollWidth * 0.75, s._scrollWidth *
                        0.25
                    ],
                    [s._scrollWidth * 0.75, s._scrollWidth *
                        0.75
                    ],
                    [s._scrollWidth * 0.25, s._scrollWidth *
                        0.5
                    ]
                ], true, grd);
            }
            if (s._ll_bar_back) {
                ...
                s._scroll_w.graphics.drawRect(0, "#000000", [s._mask
                    .getWidth() - s._scrollWidth, 0, s._scrollWidth,
                    s._scrollWidth
                ]);
                s._scroll_w.graphics.drawVertices(1, "#CCCCCC", [
                    [s._mask.getWidth() - s._scrollWidth *
                        0.75, s._scrollWidth * 0.25
                    ],
                    [s._mask.getWidth() - s._scrollWidth *
                        0.75, s._scrollWidth * 0.75
                    ],
                    [s._mask.getWidth() - s._scrollWidth *
                        0.25, s._scrollWidth * 0.5
                    ]
                ], true, grd);
            }
    ...
    LScrollbar.prototype.resizeHeight = function(value) {
        ...
        if (s._scroll_h_bar == null) {
            ...
            grd = LGlobal.canvas.createLinearGradient(0, 0, s._scrollWidth *
                ((LGlobal.mobile && s.mode == "touch") ? 1 : 2),
                0);
            grd.addColorStop(0, "#FFFFFF");
            grd.addColorStop(1, "#008000");
            grdb = LGlobal.canvas.createLinearGradient(0, 0, s._scrollWidth,
                0);
            grdb.addColorStop(0, "#FFFFFF");
            grdb.addColorStop(1, "#CCCCCC");
            if (s._ll_bar_select) {
                ...
                s._scroll_h_bar.graphics.drawRoundRect(1, "#CCCCCC", [
                    0, 0, s._scrollWidth, s._scrollWidth *
                    1.5, s._scrollWidth * 0.5
                ], true, grd);
            }
            if (s._ll_bar_back) {
                s._ll_bar_back_h = s._ll_bar_back.clone();
                s._ll_bar_back_h.y = (s._mask.getHeight() - s._ll_bar_back_h
                    .getHeight()) * 0.5;
                s._scroll_h.addChild(s._ll_bar_back_h);
            } else {
                s._scroll_h.graphics.drawRoundRect(1, "#CCCCCC", [0,
                    s._scrollWidth, s._scrollWidth, s._mask
                    .getHeight() - s._scrollWidth * 2, s._scrollWidth *
                    0.5
                ], true, grdb);
            }
            if (s._ll_bar_back) {
                ...
                s._scroll_h.graphics.drawRect(0, "#000000", [0, 0,
                    s._scrollWidth, s._scrollWidth
                ]);
                s._scroll_h.graphics.drawVertices(1, "#CCCCCC", [
                    [s._scrollWidth / 4, s._scrollWidth *
                        0.75
                    ],
            ...
            if (s._ll_bar_back) {
                ...
                s._scroll_h.graphics.drawRect(0, "#000000", [0, s._mask
                    .getHeight() - s._scrollWidth, s._scrollWidth,
                    s._scrollWidth
                ]);
                s._scroll_h.graphics.drawVertices(1, "#CCCCCC", [
                    [s._scrollWidth / 4, s._mask.getHeight() -
                        s._scrollWidth * 0.75
                    ],
                    [s._scrollWidth / 2, s._mask.getHeight() -
                        s._scrollWidth * 0.25
                    ],
                    [s._scrollWidth * 0.75, s._mask.getHeight() -
                        s._scrollWidth * 0.75
                    ]
                ], true, grd);
            }
    ...
    LScrollbar.prototype.setScroll_h = function() {
        var s = this;
        var sy = (s._mask.getHeight() - s._scrollWidth * 2 - s._selectHeight) *
    ...
    LScrollbar.prototype.setScroll_w = function() {
        var s = this;
        var sx = (s._mask.getWidth() - s._scrollWidth * 2 - s._selectHeight) *
    ...
    LScrollbar.prototype.moveDown = function() {
        ...
        if (!s._key["Dkey"] && s._showObject.y <= s._target.y) {
            ...
            s.setScroll_h();
            return;
        } else if (s._showObject.y <= s._mask.getHeight() - s._showObject
            .getHeight()) {
            s._showObject.y = s._mask.getHeight() - s._showObject.getHeight();
            s._key["down"] = false;
            s.setScroll_h();
    ...
    LScrollbar.prototype.moveRight = function() {
        ...
        if (!s._key["Dkey"] && s._showObject.x <= s._target.x) {
            ...
            s.setScroll_w();
            return;
        } else if (s._showObject.x <= s._mask.getWidth() - s._showObject
            .getWidth()) {
            s._showObject.x = s._mask.getWidth() - s._showObject.getWidth();
            s._key["right"] = false;
            s.setScroll_w();
    ...
    LScrollbar.prototype.mouseDown = function(event) {
        var s = event.clickTarget;
        if (s._scroll_h != null && event.selfX >= s._scroll_h.x &&
            event.selfX <= s._scroll_h.x + s._scrollWidth) {
            s.mouseDownH(event, s);
        }
        if (s._scroll_w != null && event.selfY >= s._scroll_w.y &&
            event.selfY <= s._scroll_w.y + s._scrollWidth) {
    ...
    LScrollbar.prototype.mouseMoveH = function(event) {
        ...
        s._key["up"] = false;
        s._key["down"] = false;
        s._target.y = (s._mask.getHeight() - s._showObject.getHeight()) *
            (mx - s._scrollWidth) / (s._mask.getHeight() - s._scrollWidth *
                3.5);
    ...
    LScrollbar.prototype.mouseMoveW = function(event) {
        ...
        s._key["left"] = false;
        s._key["right"] = false;
        s._target.x = (s._mask.getWidth() - s._showObject.getWidth()) *
            (my - s._scrollWidth) / (s._mask.getWidth() - s._scrollWidth *
                3.5);
    ...
    LScrollbar.prototype.mouseDownW = function(event) {
        ...
        if (event.selfX >= 0 && event.selfX <= s._scrollWidth) {
            ...
            s.setSpeed();
            if (!LGlobal.stage.hasEventListener(LMouseEvent.MOUSE_UP,
                    s.mouseUpW)) {
                LGlobal.stage._ll_scrollbar = s;
                LGlobal.stage.addEventListener(LMouseEvent.MOUSE_UP,
                    s.mouseUpW);
            }
        } else if (event.selfX >= s._mask.getWidth() - s._scrollWidth &&
            event.selfX <= s._mask.getWidth()) {
            if (s._showObject.x <= s._mask.getWidth() - s._showObject
                .getWidth() || s._key["left"]) {
                return;
            }
            s._distance = 10;
            if (s._showObject.x - s._distance < s._mask.getWidth() -
                s._showObject.getWidth()) {
                s._distance = s._showObject.x - s._mask.getWidth() +
                    s._showObject.getWidth();
            }
            s._target.x = s._showObject.x - s._distance;
            s._key["right"] = true;
        ...
        } else if (event.selfX >= s._scroll_w_bar.x && event.selfX <=
            s._scroll_w_bar.x + s._scroll_w_bar.getWidth() && !s._key[
                "scroll_w"]) {
            ...
            s._key["right"] = false;
            s._target.x = (s._mask.getWidth() - s._showObject.getWidth()) *
                (event.selfX - s._scrollWidth) / (s._mask.getWidth() -
                    s._scrollWidth * 3.5);
            if (s._target.x > s._showObject.x) {
                s._key["left"] = true;
            } else {
    ...
    LScrollbar.prototype.mouseDownH = function(event) {
        ...
        if (event.selfY >= 0 && event.selfY <= s._scrollWidth) {
        ...
        } else if (event.selfY >= s._mask.getHeight() - s._scrollWidth &&
            event.selfY <= s._mask.getHeight()) {
            if (s._showObject.y <= s._mask.getHeight() - s._showObject
                .getHeight()) {
                return;
            }
            s._distance = 10;
            if (s._showObject.y - s._distance < s._mask.getHeight() -
                s._showObject.getHeight()) {
                s._distance = s._showObject.y - s._mask.getHeight() +
                    s._showObject.getHeight();
            }
            s._target.y = s._showObject.y - s._distance;
            s._key["down"] = true;
        ...
        } else if (event.selfY >= s._scroll_h_bar.y && event.selfY <=
            s._scroll_h_bar.y + s._scroll_h_bar.getHeight() && !s._key[
                "scroll_h"]) {
            ...
            s._key["down"] = false;
            s._target.y = (s._mask.getHeight() - s._showObject.getHeight()) *
                (event.selfY - s._scrollWidth) / (s._mask.getHeight() -
                    s._scrollWidth * 3.5);
            if (s._target.y > s._showObject.y) {
                s._key["up"] = true;
            } else {
...
var LWindow = (function() {
    function LWindow() {
        ...
        if (style.header) {
            ...
            s.bar.w = s.w;
            s.bar.h = 30;
            var barGrd = LGlobal.canvas.createLinearGradient(0, -s.bar.h *
                0.5, 0, s.bar.h * 2);
            barGrd.addColorStop(0, "#FFFFFF");
            barGrd.addColorStop(1, s.barColor);
            s.bar.graphics.drawRoundRect(1, s.barColor, [0, 0, s.bar.w,
                s.bar.h, s.bar.h * 0.1
            ], true, barGrd);
        }
        s.addChild(s.bar);
        s.bar.addEventListener(LMouseEvent.MOUSE_DOWN, s._onBarDown);
        if (style.title && typeof style.title == "object" && style.title
            .type == "LTextField") {
            s.title = style.title;
        } else {
        ...
        if (style.closeButton) {
            ...
            var closeGrd = LGlobal.canvas.createLinearGradient(0, -s.closeObj
                .h * 0.5, 0, s.closeObj.h * 2);
            closeGrd.addColorStop(0, "#FFFFFF");
            closeGrd.addColorStop(1, "#800000");
            s.closeObj.graphics.drawRoundRect(1, "#800000", [0, 0, s.closeObj
                .w, s.closeObj.h, s.closeObj.h * 0.1
            ], true, closeGrd);
            s.closeObj.graphics.drawLine(4, "#FFFFFF", [15, 5, s.closeObj
                .w - 15, s.closeObj.h - 5
            ]);
            s.closeObj.graphics.drawLine(4, "#FFFFFF", [15, s.closeObj.h -
                5, s.closeObj.w - 15, 5
            ]);
        }
        ...
        if (style.background) {
            ...
            s.background.graphics.drawRect(1, s.barColor, [0, 0, s.w, s
                .layer.h
            ], true, s.layerColor);
        }
...
LTable.prototype.addRow = function() {
    ...
    for (var i = 0; i < s.col; i++) {
        ...
        upLayer.graphics.drawRect(st.borderWidth, st.borderColor, [0, 0, w,
            h
        ], true, st.backgroundColor);
        var overLayer = new LSprite();
        overLayer.graphics.drawRect(st.borderWidth, st.borderColor, [0, 0,
            w, h
        ], true, st.selectColor);
        ...
        if (rowLayer.childList.length > 0) {
            ...
            for (var j = 0; j < s.col; j++) {
                ...
                if (w != colLayer.getWidth() || h != colLayer.getHeight()) {
                    colLayer.bitmap_up.graphics.drawRect(st.borderWidth, st
                        .borderColor, [0, 0, w, h], true, st.backgroundColor
                    );
                    colLayer.bitmap_over.graphics.drawRect(st.borderWidth,
                        st.borderColor, [0, 0, w, h], true, st.selectColor
                    );
                }
                colLayer.x = toX;
                ...
                if (child) {
                    if (child.getWidth() >= w) {
                        for (var k = 0, l = t.length; k < l; k++) {
                            t[k][j].width = child.getWidth() + s.style.indentX *
                                2;
                        }
                    }
                    if (child.getHeight() >= h) {
                        for (var k = 0, l = t[row].length; k < l; k++) {
                            t[i][k].height = child.getHeight() + s.style.indentY *
                                2;
                        }
                    }
                    w = t[i][j].width, h = t[i][j].height;
...
LTable.prototype._createOriginalTable = function() {
    ...
    for (var i = 0; i < s.row; i++) {
        ...
        for (var j = 0; j < s.col; j++) {
            w = t[i][j].width, h = t[i][j].height;
            var upLayer = new LSprite();
            upLayer.graphics.drawRect(st.borderWidth, st.borderColor, [0, 0,
                w, h
            ], true, st.backgroundColor);
            var overLayer = new LSprite();
            overLayer.graphics.drawRect(st.borderWidth, st.borderColor, [0,
                0, w, h
            ], true, st.selectColor);
            var colLayer = new LButton(upLayer, overLayer);
            colLayer.setCursorEnabled(false);
...
LTreeWidget.prototype._createBranch = function(layer, parentBranch, deep, list) {
    ...
    for (var i = 0, l = list.length; i < l; i++) {
        ...
        if (item.branch && item.branch.length > 0) {
            ...
            branchBtn.graphics.drawVertices(0, "", [
                [0, 0],
                [s._branchBtnSize, s._branchBtnSize / 2],
                [0, s._branchBtnSize]
            ], true, s.style.branchButtonColor);
            branchLayer.addChild(branchBtn);
            branchBtn.addEventListener(LMouseEvent.MOUSE_UP, s._openOrCloseBranch);
            s._createBranch(branchLayer.branch, branchLayer, deep + 1, item
                .branch);
        }
...
LTreeWidget.prototype._openOrCloseBranch = function(event) {
    ...
    if (branchBtn.status == LTreeWidget.BRANCH_CLOSE) {
        ...
        branchBtn.graphics.drawVertices(0, "", [
            [0, 0],
            [s._branchBtnSize, 0],
            [s._branchBtnSize / 2, s._branchBtnSize]
        ], true, s.style.branchButtonColor);
...
var LListView = (function() {
    function LListView() {
        var self = this;
        base(self, LSprite, []);
        var bitmapData = new LBitmapData(null, 0, 0, 100, 100,
    ...
    LListView.prototype._ll_ondown = function(event) {
        ...
        var dragObject = new LListViewDragObject(self, event.selfX,
            event.selfY);
    ...
    LListView.prototype.isInClipping = function(index) {
        ...
        return self.clipping.x <= x && self.clipping.x + self.clipping
            .width > x && self.clipping.y <= y && self.clipping.y +
            self.clipping.height > y;
    };
    LListView.prototype._ll_onframe = function(event) {
        var self = event.currentTarget;
        if (self.clipping.x == self._ll_x && self.clipping.y ==
            self._ll_y) {
            return;
        }
        ...
        addX = addY = 1;
        if (self.arrangement == LListView.Direction.Horizontal) {
            for (var i = 0, l = Math.ceil(self.clipping.height /
                    self.cellHeight) + addY; i < l; i++) {
                var xIndex = (startY + i) * self.maxPerLine +
                    startX;
                for (var j = 0, jl = Math.ceil(self.clipping.width /
                        self.cellWidth) + addX; j < self.maxPerLine &&
                    j < jl; j++) {
                    var index = xIndex + j;
                    if (index < 0) continue;
                    if (index >= length) {
                    ...
                    item.updateView(self.bitmap, new LRectangle(0,
                            0, self.cellWidth, self.cellHeight),
                        new LPoint(x - self.clipping.x, y -
                            self.clipping.y));
                }
            }
        } else {
            for (var i = 0, l = Math.ceil(self.clipping.width /
                    self.cellWidth) + addX; i < l; i++) {
                var yIndex = (startX + i) * self.maxPerLine +
                    startY;
                for (var j = 0, jl = Math.ceil(self.clipping.height /
                        self.cellHeight) + addY; j < self.maxPerLine &&
                    j < jl; j++) {
                    var index = yIndex + j;
                    if (index < 0) continue;
                    if (index >= length) {
    ...
    LListView.prototype.clickOnChild = function(selfX, selfY, type) {
        ...
        var index;
        if (self.arrangement == LListView.Direction.Horizontal) {
            index = (y / self.cellHeight >>> 0) * self.maxPerLine +
                (x / self.cellWidth >>> 0);
        } else {
            index = (y / self.cellHeight >>> 0) + (x / self.cellWidth >>>
                0) * self.maxPerLine;
        }
    ...
    LListView.prototype.dragStart = function() {
        var self = this;
        if (self.scrollBarHorizontal.showCondition == LListView.ScrollBarCondition
            .WhenDragging) {
            self.scrollBarHorizontal.visible = true;
        }
        if (self.scrollBarVertical.showCondition == LListView.ScrollBarCondition
            .WhenDragging) {
    ...
    LListView.prototype.resizeScrollBar = function() {
        ...
        var length = self._ll_items.length;
        if (self.arrangement == LListView.Direction.Horizontal) {
            w = self.cellWidth * (length > self.maxPerLine ? self.maxPerLine :
                length);
            h = self.cellHeight * Math.ceil(length / self.maxPerLine);
        } else {
            h = self.cellHeight * (length > self.maxPerLine ? self.maxPerLine :
                length);
            w = self.cellWidth * Math.ceil(length / self.maxPerLine);
        }
        scaleX = self.clipping.width < w ? self.clipping.width / w :
            1;
        scaleY = self.clipping.height < h ? self.clipping.height /
            h : 1;
    ...
    LListView.prototype.setScrollBarVisible = function(bar, scale) {
        if (bar.showCondition == LListView.ScrollBarCondition.Always) {
            bar.visible = true;
        } else if (bar.showCondition == LListView.ScrollBarCondition
            .OnlyIfNeeded) {
            if (scale >= 1) {
                bar.visible = false;
            } else {
...
var LListScrollBar = (function() {
    function LListScrollBar(background, foreground, showCondition) {
        var self = this;
        base(self, LSprite, []);
        self.background = background ? background : new LPanel(
            "#333333", 8, 8);
        self.addChild(self.background);
        self.foreground = foreground ? foreground : new LPanel(
            "#CCCCCC", 8, 8);
        self.addChild(self.foreground);
        self.showCondition = showCondition ? showCondition : LListView.ScrollBarCondition
            .OnlyIfNeeded;
    }
    ...
    LListScrollBar.prototype.resizeHeight = function(value) {
        var self = this;
        self.background.cacheAsBitmap(false);
        self.background.resize(self.background.getSize().width,
            value);
        self.background.cacheAsBitmap(true);
    };
    LListScrollBar.prototype.setWidthScale = function(value) {
        ...
        self.foreground.resize(self.background.getSize().width *
            value, self.foreground.getSize().height);
        self.foreground.cacheAsBitmap(true);
    };
    LListScrollBar.prototype.setHeightScale = function(value) {
        var self = this;
        self.foreground.cacheAsBitmap(false);
        self.foreground.resize(self.foreground.getSize().width,
            self.background.getSize().height * value);
        self.foreground.cacheAsBitmap(true);
    };
    LListScrollBar.prototype.setX = function(scaleX) {
        ...
        self.foreground.x = (self.background.getSize().width - self
            .foreground.getSize().width) * scaleX;
    };
    LListScrollBar.prototype.setY = function(scaleY) {
        ...
        self.foreground.y = (self.background.getSize().height -
            self.foreground.getSize().height) * scaleY;
    };
...
var LListChildView = (function() {
    ...
    LListChildView.prototype.updateView = function(bitmap, rectangle,
        point) {
        var self = this;
        ...
        if (self.ll_basePoint.x > self.ll_baseBitmap.bitmapData.width ||
            self.ll_basePoint.y > self.ll_baseBitmap.bitmapData.height ||
            self.ll_basePoint.x + self.ll_baseRectangle.width < 0 ||
            self.ll_basePoint.y + self.ll_baseRectangle.height < 0) {
            return;
        }
        if (!bitmap) {
            ...
            var isIn = (listView.clipping.x <= x && listView.clipping
                .x + listView.clipping.width > x && listView.clipping
                .y <= y && listView.clipping.y + listView.clipping
                .height > y);
            if (!isIn) {
                return;
            }
            ...
            self.ll_baseBitmap.bitmapData.clear(new LRectangle(self
                .ll_basePoint.x, self.ll_basePoint.y, self.ll_baseRectangle
                .width, self.ll_baseRectangle.height));
        }
        self.ll_baseBitmap.bitmapData.copyPixels(self._ll_cacheAsBitmap
            .bitmapData, self.ll_baseRectangle, self.ll_basePoint
        );
    };
...
var LListViewDragObject = (function() {
    ...
    LListViewDragObject.prototype._ll_stop = function() {
        ...
        self.stopDrag();
        self.isDeleted = true;
        if (Math.abs(mouseX - self.sx) < 5 && Math.abs(mouseY -
                self.sy) < 5) {
            self.listView.clickOnChild(mouseX - self.sx + self.selfX,
                mouseY - self.sy + self.selfY);
        }
    ...
    LListViewDragObject.prototype.dragAmend = function() {
        ...
        if (listView.clipping.x < 0) {
            if (!dragObject) {
                tx = 0;
            } else if (listView.dragEffect == LListView.DragEffects
                .MomentumAndSpring) {
            ...
            var length = listView._ll_items.length,
                width;
            if (listView.arrangement == LListView.Direction.Horizontal) {
                width = (length > listView.maxPerLine ? listView.maxPerLine :
                    length) * listView.cellWidth;
            } else {
                width = Math.ceil(length / listView.maxPerLine) *
                    listView.cellWidth;
            }
            ...
            } else if (listView.clipping.x > width - listView.clipping
                .width) {
                if (!dragObject) {
                    ...
                    listView.clipping.x = self.toX + (listView.clipping
                            .x - width + listView.clipping.width) *
                        0.5;
                } else {
                    listView.clipping.x = width - listView.clipping
                        .width;
                }
            }
        }
        if (listView.clipping.y < 0) {
            ...
            var length = listView._ll_items.length,
                height;
            if (listView.arrangement == LListView.Direction.Horizontal) {
                height = Math.ceil(length / listView.maxPerLine) *
                    listView.cellHeight;
            } else {
                height = (length > listView.maxPerLine ? listView.maxPerLine :
                    length) * listView.cellHeight;
            }
            ...
            } else if (listView.clipping.y > height - listView.clipping
                .height) {
                if (!dragObject) {
                    ...
                    listView.clipping.y = self.toY + (listView.clipping
                            .y - height + listView.clipping.height) *
                        0.5;
                } else {
                    listView.clipping.y = height - listView.clipping
                        .height;
                }
            }
        }
